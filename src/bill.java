...
//actual printing function
	...
	public bill() {
		...
		Comp_name.setFont(new Font("Niagara Engraved", Font.PLAIN, 60));
		...
		lblNewLabel_2.setIcon(new ImageIcon(imgm));
		...
		custname.setFont(new Font("Monotype Corsiva", Font.BOLD | Font.ITALIC, 25));
