...
public class mframe extends JFrame {
	...
	public mframe() {
		 ...
		 */
		userconnect= sqlconnect.dbConnector();
		upconncect = sqlconnect.dbConnector();
		...
		try {
			String query = "select username from users where email='" +ITZoneLog.gmail + "'";
		...
		Image imgbut = new ImageIcon(this.getClass().getResource("/deletelogo.png")).getImage();
		...
		deletebut.setIcon(new ImageIcon(imgbut));
		...
		Image imgcart = new ImageIcon(this.getClass().getResource("/addcart.png")).getImage();
		addToCart.setIcon(new ImageIcon(imgcart));
		...
		Image wimg = new ImageIcon(this.getClass().getResource("/whitedot.png")).getImage();
		Image bimg = new ImageIcon(this.getClass().getResource("/blackdot.png")).getImage();

		JLabel userlog = new JLabel("");
		Image img1 = new ImageIcon(this.getClass().getResource("/us.png")).getImage();
		userlog.setIcon(new ImageIcon(img1));
		...
		Image imglogo = new ImageIcon(this.getClass().getResource("/mainlogo.png")).getImage();
		mainlogo.setIcon(new ImageIcon(imglogo));
		...
		Image lapyimg = new ImageIcon(this.getClass().getResource("/lapy.png")).getImage();
		cat_1.setIcon(new ImageIcon(lapyimg));
		cat_1.setVisible(false);
		...
		Image monimg = new ImageIcon(this.getClass().getResource("/monitorpic.png")).getImage();
		cat_2.setIcon(new ImageIcon(monimg));
		...
		Image cpuimg = new ImageIcon(this.getClass().getResource("/cpupic.png")).getImage();
		cat_3.setIcon(new ImageIcon(cpuimg));
		...
		Image mouseimg = new ImageIcon(this.getClass().getResource("/mousepic.png")).getImage();
		cat_4.setIcon(new ImageIcon(mouseimg));
		...
		Image cableimg = new ImageIcon(this.getClass().getResource("/cablepic.png")).getImage();
		cat_5.setIcon(new ImageIcon(cableimg));
		...
		Image keyimg = new ImageIcon(this.getClass().getResource("/keyboardpic.png")).getImage();
		cat_6.setIcon(new ImageIcon(keyimg));
		...
		Image pendimg = new ImageIcon(this.getClass().getResource("/pendrivepic.png")).getImage();
		cat_7.setIcon(new ImageIcon(pendimg));
		...
		Image imgitz = new ImageIcon(this.getClass().getResource("/ctz.png")).getImage();
		cat.setIcon(new ImageIcon(imgitz));
		...
		Image imgusrd = new ImageIcon(this.getClass().getResource("/usrdetailpic.png")).getImage();
		usrdata.setIcon(new ImageIcon(imgusrd));
		...
		Image imgadd = new ImageIcon(this.getClass().getResource("/addDatalogo.png")).getImage();
		addDataLog.setIcon(new ImageIcon(imgadd));
		...
		Image imgplogo = new ImageIcon(this.getClass().getResource("/printlogo.png")).getImage();
		print.setIcon(new ImageIcon(imgplogo));
		print.repaint();
		...
		Image imgreset = new ImageIcon(this.getClass().getResource("/resetlogo.png")).getImage();
		lblReset.setBorder(BorderFactory.createRaisedBevelBorder());
		lblReset.setIcon(new ImageIcon(imgreset));
		...
		ImageIcon Listimg = new ImageIcon("/listlogo.png");
		Image imglist = new ImageIcon(this.getClass().getResource("/listlogo.png")).getImage();
		...
		lblNewLabel_14.setBackground(new Color(176, 224, 230));
		lblNewLabel_14.setFont(new Font("Niagara Engraved", Font.PLAIN, 45));
		...
		Image imgdcart = new ImageIcon(this.getClass().getResource("/directcart.png")).getImage();
		lblAddToCart.setIcon(new ImageIcon(imgdcart));
		...
		Image imgps = new ImageIcon(this.getClass().getResource("/printsettinglogo.png")).getImage();
		lblSetting.setIcon(new ImageIcon(imgps));
		...
		Image imgpss = new ImageIcon(this.getClass().getResource("/updateTable.png")).getImage();

		updateT.setIcon(new ImageIcon(imgpss));
